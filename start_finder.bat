...
python roblox_finder.py --loop 90 --keyword-mode full --search-pages 3 --sort-pages 20 --keyword-limit 500 --snowball-hops 3 --csv --watchlist-file watchlist_history.csv --nodiscord-file nodiscord_history.csv --seed-file watchlist_history.csv --seed-file results_history.csv >> results_history.csv 2>> finder.log
